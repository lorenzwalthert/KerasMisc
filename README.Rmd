...
* a Keras callback for cyclical learning rate scheduling as proposed by 
  ...
  [Python implementation](https://github.com/bckenstler/CLR). Please see the 
  [README](https://github.com/bckenstler/CLR) from the Python 
  implementation for details. It's really almost a 1:1 translation.
...
plot_clr_history(callback_clr, backend = backend)
